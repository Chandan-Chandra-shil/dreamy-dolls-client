      ...
      <div className="grid md:grid-cols-3 items-center my-12 gap-10">
        ...
        <div className="md:col-span-2 space-y-6 ">
          ...
          <p className="px-5">
            ...
            you are looking for a new friend for your little one or searching for
            the perfect gift, we are here to help you find that dreamy doll that
            will ignite their imagination and become a cherished companion for
            years to come.
          </p>
